...
app.config['SECRET_KEY'] = os.environ.get('SECRET_KEY', 'tiptop-2024-secret-key-change-in-production')
...
app.config['SQLALCHEMY_DATABASE_URI'] = database_url or 'sqlite:///tiptop.db'
...
# File upload configuration for cloud storage
app.config['UPLOAD_FOLDER'] = 'static/ads_images'
